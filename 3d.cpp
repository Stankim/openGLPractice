...
-0.5f, -0.5f, -0.5f,	0.0f, 0.0f, 1.0f,	0.9f, 0.0f
};
...
int modelLoc = glGetUniformLocation(ownShader.ID, "model");
glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

int viewLoc = glGetUniformLocation(ownShader.ID, "view");
glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));

int projectionLoc = glGetUniformLocation(ownShader.ID, "projection");
